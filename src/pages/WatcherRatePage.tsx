...
export const WatcherRatePage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await apiClient.post(`/watchers/${token}/ratings`, { scores: scoreList });
            setSubmitted(true);
        } catch (err: any) {
    ...
    if (context?.alreadyRated || submitted) {
        const name = context?.watcherName ?? '';
        return (
            <div className="min-h-screen bg-background flex items-center justify-center p-4">
                <div className="glass-panel max-w-md w-full text-center p-8">
                    <div className="text-4xl mb-4">✅</div>
            ...
            <div className="max-w-[600px] mx-auto">
                <div className="mb-8">
                    ...
                    <p className="text-slate-500 text-sm mt-1">
                        Puanlayan: <span className="text-white font-semibold">{context.watcherName}</span>
                    </p>
                </div>
